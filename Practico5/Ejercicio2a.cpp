...
void insertarFinal(lista& l, int elemento) {
...
void enOrdenAux(AB arbol, lista& l) {
    if (arbol == NULL) return;

    enOrdenAux(arbol->izq, l);
    insertarFinal(l, arbol->elem);
    enOrdenAux(arbol->der, l);
}

lista enOrden(AB arbol) {
    lista resultado = NULL;
    enOrdenAux(arbol, resultado);
    return resultado;
}

void preOrdenAux(AB arbol, lista& l) {
    if (arbol == NULL) return;

    insertarFinal(l, arbol->elem);
    preOrdenAux(arbol->izq, l);
    preOrdenAux(arbol->der, l);
}

lista preOrden(AB arbol) {
    lista resultado = NULL;
    preOrdenAux(arbol, resultado);
    return resultado;
}

void postOrdenAux(AB arbol, lista& l) {
    if (arbol == NULL) return;

    postOrdenAux(arbol->izq, l);
    postOrdenAux(arbol->der, l);
    insertarFinal(l, arbol->elem);
}
